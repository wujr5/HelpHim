...
#       title: '突然下大雨，求带雨伞'
#       type: '生活'
#       description: '天突降大雨，被困图书馆，赶时间回宿舍，求好心人帮忙带伞，重酬!天突降大雨，被困图书馆，赶时间回宿舍，求好心人帮忙带伞，重酬!天突降大雨，被困图书馆，赶时间回宿舍，求好心人帮忙带伞，重酬!天突降大雨，被困图书馆，赶时间回宿舍，求好心人帮忙带伞，重酬!'
#       createdBy: '吴家荣'
#       createdAt: new Date()
#       reward: '一顿麦当劳！'
...
#       contact: '13800138000'
#       state: '已经有执行者但未完成' # state: 三种状态：已完成，已经有执行者但未完成，无执行者且未完成
#     }
#     AllTasks.insert {
#       title: '新生报到，请求搬行李'
#       type: '生活'
